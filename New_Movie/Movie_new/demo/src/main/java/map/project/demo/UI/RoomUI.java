...
//                roomController.updateRoomNumber(String.valueOf(roomToUpdate), newRoomNumber);
//            } else if (choice == 2) {
//                System.out.println("Enter new number of seats:");
//                int newNumberOfSeats = keyboard.nextInt();
//                roomController.updateNumberOfSeats(String.valueOf(roomToUpdate), newNumberOfSeats);
//            }
//        }
//    }
//
